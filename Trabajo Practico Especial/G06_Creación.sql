...
ALTER TABLE G06_MOVIMIENTO
    ADD CONSTRAINT FK_G06_MOVIMIENTO_MOVIMIENTO FOREIGN KEY (id_mov_ant)
    REFERENCES G06_MOVIMIENTO (id_movimiento)
;
...
CREATE SEQUENCE SQ_G06_MOVIMIENTO_CC_ID_MOVIMIENTO START 80000 
OWNED BY G06_MOVIMIENTO_CC.id_mov_cc;

CREATE SEQUENCE SQ_G06_LINEA_ALQUILER_ID_LIQUIDACION START 10000
OWNED BY G06_LINEA_ALQUILER.id_liquidacion;


--########################################################################
--INSERCION DE DATOS DESDE EL ESQUEMA
--########################################################################
